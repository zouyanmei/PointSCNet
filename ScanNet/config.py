...
raw_data_path = Path("/home/dell/zym/data/scannet/pt2/scannet")
...
scan_test = Path(__file__).parent / "scannetv2_test.txt"
...
with open(scan_test, 'r') as file:
    scan_test = [line.strip() for line in file.readlines()]
