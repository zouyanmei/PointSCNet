...
class ScanNetV2(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return xyz, feature, indices, lbl, npoint
    ...
    def get_test_item(self, idx):
        ...
        return xyz, feature, indices, full_nn, full_lbl, npoint
...
def scan_collate_fn(batch):
    ...
    [[xcil], [xcil], ...]
    """
    xyz, col, indices, lbl, npoint = list(zip(*batch))
    ...
    return xyz, col, indices, pts, lbl, npoint
