...
from config import processed_data_path, scan_train, scan_val, scan_test
...
class ScanNetV2(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return xyz, feature, indices, npoint, file_name
    ...
    def get_test_item(self, idx):
        ...
        return xyz, feature, indices, full_nn, npoint, file_name
...
def scan_collate_fn(batch):
    ...
    [[xcil], [xcil], ...]
    """
    xyz, col, indices, npoint, file_name = list(zip(*batch))
    ...
    npoint = torch.tensor(npoint, dtype=torch.int64).contiguous()

    return xyz, col, indices, pts, npoint, file_name
